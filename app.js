  ...
  return `<div class="post-card">
    <div class="post-header">
      ...
      <div class="post-header-right">
        ...
        ${(userProfile?.isAdmin || userProfile?.role === 'admin') ? `<button class="icon-btn" style="width:34px; height:34px; font-size:1rem; border-color:var(--border); background:var(--bg2)" onclick="openEditModal('${p.id}')" title="Edit Post">✏️</button>` : ''}
