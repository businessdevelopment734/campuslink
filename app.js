...
function renderDateEvents(date) {
  ...
  listContainer.innerHTML = filtered.map((p, i) => {
    const evDate = new Date(p.eventData.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
    return `
      <div class="cal-event-card" style="animation-delay: ${i * 0.1}s" onclick="closeCalendar(); scrollToPost('${p.id}')">
        ...
        <div class="cec-info">
          ...
          <div class="cec-footer">
            <span class="cec-time">⏰ ${evDate}</span>
